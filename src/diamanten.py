...
def create_message():
    ...
    return '\n'.join([
        "German market update (local time: %s) (nyse time: %s) (generated by halfdane's [Diamantenbot](https://github.com/halfdane/diamantenbot))  " % (
            now.astimezone(ger).strftime("%T"), now.astimezone(nyse).strftime("%T")),
        "**$%.2f** ([€%.2f](https://www.tradegate.de/orderbuch.php?isin=US36467W1099)@[%.4f](https://www.onvista.de/devisen/Eurokurs-Euro-Dollar-EUR-USD)) **volume: %s**   " % (
